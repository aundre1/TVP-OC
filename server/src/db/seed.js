...
const memberships = [
  {
    name: 'Free',
    slug: 'free',
    description: 'Browse and explore with limited downloads',
    price_monthly: 0,
    price_annual: null,
    price_lifetime: null,
  ...
  },
  {
    name: 'Starter',
    slug: 'starter',
    description: 'Great for active DJs who need regular content',
    price_monthly: 35.00,
    price_annual: null,
    price_lifetime: null,
    stripe_price_monthly: process.env.STRIPE_PRICE_STARTER_MONTHLY || 'price_starter_monthly',
    stripe_price_annual: null,
    stripe_price_lifetime: null,
    features: {
      preview: true,
  ...
  },
  {
    name: 'Pro',
    slug: 'pro',
    description: 'For professional DJs who demand the best',
    price_monthly: 33.33,
    price_annual: null,
    price_lifetime: null,
    stripe_price_monthly: process.env.STRIPE_PRICE_PRO_QUARTERLY || 'price_pro_quarterly',
    stripe_price_annual: null,
    stripe_price_lifetime: null,
    features: {
      preview: true,
  ...
  },
  {
    name: 'Elite',
    slug: 'elite',
    description: 'Ultimate access with exclusive content and priority support',
    price_monthly: 30.00,
    price_annual: 360.00,
    price_lifetime: null,
    stripe_price_monthly: null,
    stripe_price_annual: process.env.STRIPE_PRICE_ELITE_ANNUAL || 'price_elite_annual',
    stripe_price_lifetime: null,
    features: {
      preview: true,
      download: true,
