...
// ===========================================
// AUTO-MIGRATE ON STARTUP (idempotent IF NOT EXISTS)
// ===========================================
(async () => {
  try {
    ...
    console.log("[STARTUP] ✓ Migration 019 applied (spotify_id, apple_id)");
  } catch (err) {
    // Log but don't crash — columns may already exist or table not accessible
